...
5. Then __aggregate, by calculating the mean__, all the hourly performance measures on the whole subset to choose the regression learning method that globally performs the best
6. For each desired hourly datasets, apply the choosen combination of learning method + explanatory variables to __build a model__ to make spatial predictions
...
[spatialization methodology viewer](./assets/uml_images/spatialization-methodology.png)
